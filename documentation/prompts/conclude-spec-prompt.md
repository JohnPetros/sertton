...
1.  **Validação de Qualidade Final:**
    *   **Análise Estática:** Execute `analyze_files` em todo o projeto para garantir que não existam warnings ou erros remanescentes.
    *   **Testes Unitários:** Execute `run_tests` para validar que todos os testes (novos e existentes) estão passando.
